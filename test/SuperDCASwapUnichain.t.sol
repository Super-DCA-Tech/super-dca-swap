...
contract SuperDCASwapUnichainTest is Test {
    ...
    function test_ExactOutputSingle_ETH_For_DCA() public {
        ...
        // Execute swap (ETH -> DCA: zeroForOne = true in DCA_ETH pool where ETH is currency0)
        vm.prank(address(swapContract));
        ...
        console.log("--- ETH -> DCA Exact Output Swap (Unichain) ---");
    ...
    function test_ExactOutputSingle_DCA_For_USDC() public {
        uint128 exactAmountOut = 1e6; // USDC
        uint128 maxAmountIn = 500e18; // DCA
        ...
        // Execute swap (DCA -> USDC: zeroForOne = false since in DCA_USDC_KEY, DCA is currency1, USDC is currency0)
        vm.prank(address(swapContract));
        ...
        console.log("--- DCA -> USDC Exact Output Swap (Unichain) ---");
