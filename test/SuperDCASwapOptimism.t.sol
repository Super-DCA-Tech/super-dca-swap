...
contract SuperDCASwapOptimismTest is Test {
    address constant UNIVERSAL_ROUTER_ADDRESS = 0x851116D9223fabED8E56C0E6b8Ad0c31d98B3507;
    address constant POOL_MANAGER_ADDRESS = 0x9a13F98Cb987694C9F086b1F5eB990EeA8264Ec3;
    ...
    /// @dev Integration testing on Optimism
    /// Uniswap V4Pools on Optimism
    ///  * USDC-DCA, 1% fee, no hook
    ///  * ETH-DCA, 1% fee, no hook
    ///  * UNI-DCA, 1% fee, no hook
    ...
    PoolKey DCA_UNI_KEY = PoolKey({
        currency0: Currency.wrap(UNI_ADDRESS),
        currency1: Currency.wrap(DCA_ADDRESS),
        fee: 10000,
        tickSpacing: 200,
        hooks: IHooks(address(0))
